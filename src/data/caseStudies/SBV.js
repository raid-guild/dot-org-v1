...
export default {
  ...
  challengeText: 'SBV approached Raid Guild seeking guidance on the structure of their new DAO. The challenge was to determine which DAO structure best aligned with the features they wished to include. Additionally, SBV had no prior branding or website and would need Raid Guild to handle that as well.s',
